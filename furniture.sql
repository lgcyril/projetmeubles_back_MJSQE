...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1123841468ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="272">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tables récentes" class="drop_button btn">Récentes</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=furniture&table=furniture">`furniture`.`furniture`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=socialnetwork&table=tags">`socialnetwork`.`tags`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=socialnetwork&table=followers">`socialnetwork`.`followers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=socialnetwork&table=users">`socialnetwork`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=socialnetwork&table=posts">`socialnetwork`.`posts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=socialnetwork&table=posts_tags">`socialnetwork`.`posts_tags`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=information_schema&table=APPLICABLE_ROLES">`information_schema`.`APPLICABLE_ROLES`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mysql&table=columns_priv">`mysql`.`columns_priv`</a></li></ul></div><div class="drop_list"><button title="Tables préférées" class="drop_button btn">Préférées</button><ul id="pma_favorite_list"><li class="warp_link">Pas de tables préférées.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="5950467848584642567b5573615f5a6c">
...
</span><small>Définir à 0 pour replier le panneau de navigation.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="272"><a class="restore-default hide" href="#NavigationWidth" title="Restaurer la valeur par défaut"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Faire Entrée pour exécuter la requête                    </span>
                            ...
                            targetdb="furniture" targettable="">
            ...
            Daté du
                            ...
                            <span class="query">CREATE TABLE `furniture` (
    ...
    PRIMARY KEY(`id`)
            ...
            Daté du
                            ...
                            <span class="query">DROP table furniture;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="furniture" targettable="">
                            <div class="action_content">
    ...
    PRIMARY KEY(`id`)
                            ...
                            targetdb="furniture" targettable="furniture">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `furniture`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="furniture" targettable="furniture">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">INSERT INTO `furniture` (`id`, `name`, `img_url`, `description`, `category`, `price`, `created`) VALUES (NULL, &#039;Chaises rouges&#039;, &#039;https://img.leboncoin.fr/api/v1/lbcpb1/images/ef/b3/d4/efb3d43a9cdaa43f37f0fd9e30c2d2a48ddcab19.jpg&#039;, &#039;Un ensemble de chaises rouges qui n\&#039;ont rien de particulier&#039;, &#039;chaises&#039;, &#039;50&#039;, &#039;2022-06-28 11:05:01.000000&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
            ...
            Daté du
                            ...
                            <span class="query">CREATE USER &#039;furniture_api&#039;@&#039;%&#039; IDENTIFIED VIA mysql_native_password USING &#039;***&#039;;GRANT SELECT, INSERT, UPDATE, DELETE, CREATE, FILE, INDEX, ALTER, CREATE TEMPORARY TABLES, CREATE VIEW, EVENT, TRIGGER, SHOW VIEW, CREATE ROUTINE, ALTER ROUTINE, EXECUTE ON *.* TO &#039;furniture_api&#039;@&#039;%&#039; REQUIRE NONE WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="furniture" targettable="furniture">
                            <div class="action_content">
